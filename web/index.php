    ...
    <main class="shell">
        <section class="hero">
            ...
            <div class="toolbar">
                ...
                <select id="lingua" class="field" aria-label="Filtra per lingua">
                ...
                <a class="button primary" href="index.php">
                    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="margin-right:6px"><polyline points="23 4 23 10 17 10"/><path d="M20.49 15a9 9 0 1 1-2.12-9.36L23 10"/></svg>
                    Aggiorna
                </a>
            </div>
            <div class="meta">
<span>Aggiornato: <?= h($data['updatedAt']) ?></span>
                    ...
                    <div class="grid">
                        <?php foreach ($dayEvents as $event): ?>
                            <article
                                ...
                                data-languages="<?= h(lower(implode(',', $event['languages']))) ?>"
    ...
    <script>
        ...
        function applyFilters() {
            ...
            const lingua = linguaSelect.value.toLowerCase();
            let visible = 0;
            ...
            cards.forEach((card) => {
                ...
                const matchesLingua = lingua === '' || cardLanguages.split(',').some(l => l.trim() === lingua);
                const show = matchesTerm && matchesSport && matchesLingua;
                card.hidden = !show;
                if (show) {
                    visible += 1;
                }
            ...
            if (lingua) {
                bits.push(`lingua: ${linguaSelect.value}`);
            }
        ...
        linguaSelect.addEventListener('change', applyFilters);
